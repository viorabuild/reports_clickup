            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "Твоя роль — объективно проанализировать задачу и предоставить независимую оценку скорости и качества.\n\n"
                        "МЕТОДОЛОГИЯ ОЦЕНКИ:\n\n"
                        ...
                        "• Оцени, сколько времени ДОЛЖНА была занять эта задача для специалиста данного уровня\n"
